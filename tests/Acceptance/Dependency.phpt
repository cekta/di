...
use Cekta\DI\Loader\Service;use Cekta\DI\Test\Database;
...
$container = new Container([
    ...
    'type' => 'mysql',
    'options' => [],
    'dsn' => new Service(function (ContainerInterface $container) {
        return "{$container->get('type')}:dbname={$container->get('name')};host={$container->get('host')}";
    }),
    Database::class => new Service(function (ContainerInterface $container) {
        return new Database(
            $container->get('dsn'),
