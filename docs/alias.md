...
2. **Циклические зависимости** — следите, чтобы псевдонимы не создавали циклических ссылок
3. **Совместимость типов** — заменяемый класс должен быть совместим по типу (реализовывать интерфейс или наследовать класс)
4. **Проверка на этапе компиляции** — ошибки несовместимости типов обнаруживаются при генерации кода
